...
export const env = {
  ...
  NEXT_PUBLIC_SUPPORT_INFORMATION_SHEET_GID: process.env.NEXT_PUBLIC_SUPPORT_INFORMATION_SHEET_GID || '',
  NEXT_PUBLIC_FRIENDLY_LINKS_SHEET_GID: process.env.NEXT_PUBLIC_FRIENDLY_LINKS_SHEET_GID || '',
} as const;
